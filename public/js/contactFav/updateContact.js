$(document).on("click", "#btn-update", function (e) {
    ...
    const update = `
        <div style="display: flex; flex-direction: column;">
            ...
            <input type="text" value="" id="contact-nom-update" name="contact-nom-update">
            ...
            <input type="text" value="" id="contact-prenom-update" name="contact-prenom-update">
            ...
            <input type="text" value="" id="contact-email-update" name="contact-email-update">
            ...
            <input type="text" value="" id="contact-phone-update" name="contact-phone-update">
        </div>
    `
